...
class EncoderSDF(nn.Module):
    def __init__(self,latent_size):
        ...
        self.conv1 = nn.Conv2d(3, 16, kernel_size=(10, 10))
        self.conv2 = nn.Conv2d(16, 32, kernel_size=(10, 10))
        ...
        self.conv11 = nn.Conv2d(32, 16, kernel_size=(3, 3))
        self.conv12 = nn.Conv2d(16, 1, kernel_size=(3, 3))

        self.maxpool1 = nn.MaxPool2d(4)
        self.linear1 = nn.Linear(3 * 5 + 20, latent_size)

        ...
        for batch_input_im, batch_target_code in training_generator_grid:
            ...
            if count_model%(total_model_to_show/num_epoch/10) == 0:
                ...
                for batch_input_im_validation, batch_target_code_validation in validation_generator_grid:
                    ...
                    sdf_validation = decoder(pred_vecs_validation.repeat_interleave(resolution * resolution * resolution),xyz.repeat(batch_size))
                    sdf_target= decoder(target_code_validation.repeat_interleave(resolution * resolution * resolution),xyz.repeat(batch_size))

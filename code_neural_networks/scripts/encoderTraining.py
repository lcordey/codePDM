""" 
This scripts trains an encoder that predicts the latent code corresponding to a model in an image
...
if __name__ == '__main__':
    ...
    training_set = DatasetGrid(list_hash, annotations, num_images_per_model, param["image"], param["network"], IMAGES_PATH)
    training_generator= torch.utils.data.DataLoader(training_set, **param["dataLoader"])

    validation_set = DatasetGrid(list_hash_validation, annotations, num_images_per_model, param["image"], param["network"], IMAGES_PATH)

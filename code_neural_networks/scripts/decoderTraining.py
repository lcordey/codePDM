""" 
This scripts trains a Variational decoder.
It learns the models in the "sdf" folder
It associate each training model to a latent code with a dimension that can be change in the "config/param.yaml" file
The final paramters of the decoder as well as the final latent codes are saved in the "config/models_and_codes" folder
The parameters of the training can be changed in the "config/param.yaml" file
"""
...
LOGS_PATH = "../../results/logs/decoder/log.pkl"
SDF_DIR = "../../sdf/"
